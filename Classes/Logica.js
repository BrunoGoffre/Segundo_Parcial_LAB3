...
(function (ABM) {
    ...
    ABM.camposMostrados = camposMostrados;
    function promedio() {
    ...
    function agregar() {
        if (checkInputs()) {
            ...
            if (tipo.value === "Auto") {
                ...
                var auto = new ABM.Auto(id, marca.value, modelo.value, +precio.value, +catntidadPuertas.value);
                listaVehiculos.push(auto);
                vehiculo = auto;
            }
            else {
                var cuatroXcuatro = document.getElementById("cuatroXcuatro");
                var camioneta = new ABM.Camioneta(id, marca.value, modelo.value, +precio.value, cuatroXcuatro.checked);
                listaVehiculos.push(auto);
                vehiculo = camioneta;
            }
